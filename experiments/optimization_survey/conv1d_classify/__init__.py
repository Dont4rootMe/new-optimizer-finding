"""1D convolution waveform classification experiment."""
...
class Conv1dClassifyExperiment:
    """Classify synthetic 1D waveforms with a small Conv1d network."""

    name = "conv1d_classify"
