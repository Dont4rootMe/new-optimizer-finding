"""ShinkaEvolve evaluator adapter for the co_bench experiment family.
...
lives in ``src/baselines/shinka/_evaluator.run_cli`` so all adapters
...
# ``experiments/co_bench/_baselines/shinka/evaluate.py`` ->
