...
This file applies to `experiments/_shared/`.
...
- Any change to result payload keys must stay aligned with `optbench.runner`, `src.validate.run_one`, and evolve-side scoring.
