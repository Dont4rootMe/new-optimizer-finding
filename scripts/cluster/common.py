...
DEEPGEMM_TOOLCHAIN_ID = (
    f"cuda-nvcc-{DEEPGEMM_NVCC_VERSION}-curand-{CUDA_CURAND_VERSION}"
)
DEEPGEMM_KERNEL_CACHE_ID = f"deep_gemm-sm90-cuda-nvcc-{DEEPGEMM_NVCC_VERSION}"
TVM_FFI_VERSION = "0.1.11"
TVM_FFI_CACHE_ID = (
    f"tvm-ffi-sm90-cuda-nvcc-{DEEPGEMM_NVCC_VERSION}-tvmffi-{TVM_FFI_VERSION}"
)
